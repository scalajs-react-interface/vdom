...
import sri.core.{ComponentS, CreateElement, CreateElementNoProps, ReactElement}
...
private class StyledTagsComTest extends ComponentS[State] {
  ...
  private def test1 = <.div()("Only contants.")
  ...
  private def test4 = <.a(
    ^.onClick := ((e: SyntheticEvent[_]) => println("something1"))
